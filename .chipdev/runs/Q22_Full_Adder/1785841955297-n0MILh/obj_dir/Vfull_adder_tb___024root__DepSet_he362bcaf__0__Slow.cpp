...
#endif
            VL_FATAL_MT("/home/pranav/PersonalProjects/chipdev.io/.chipdev/runs/Q22_Full_Adder/1785841955297-n0MILh/Q22_Full_Adder_tb.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfull_adder_tb___024root___dump_triggers__act(Vfull_adder_tb___024root* vlSelf) {
    ...
    if ((4ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] full_adder_tb.CIN)\n");
    }
    if ((8ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([changed] full_adder_tb.COUT)\n");
    }
...
VL_ATTR_COLD void Vfull_adder_tb___024root___dump_triggers__nba(Vfull_adder_tb___024root* vlSelf) {
    ...
    if ((4ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] full_adder_tb.CIN)\n");
    }
    if ((8ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([changed] full_adder_tb.COUT)\n");
    }
...
VL_ATTR_COLD void Vfull_adder_tb___024root___ctor_var_reset(Vfull_adder_tb___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__full_adder_tb__DOT__COUT__0 = VL_RAND_RESET_I(1);
